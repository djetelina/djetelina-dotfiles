...
# PLUGIN SELECTOR #
###################
plugins=(command-not-found debian gitfast k zsh-syntax-highlighting dotenv heroku zsh-autosuggestions pip sudo)
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status background_jobs command_execution_time kubecontext virtualenv vcs)
